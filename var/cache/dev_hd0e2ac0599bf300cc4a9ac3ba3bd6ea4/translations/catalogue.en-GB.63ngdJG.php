...
$catalogue = new MessageCatalogue('en-GB', array (
  ...
  array (
    ...
    'checkout.cartScreenReaderUpdate' => 'Shopping cart contains one item. The cart total value is %total%.|Shopping cart contains %count% items. The cart total value is %total%.',
 ...
 To complete the sign-up process, search your inbox for our confirmation email and click on the link provided with it.',
    ...
    'spatial.scanQrCode' => 'Scan QR-Code',
    'spatial.pointToQrCode' => 'Point the mobile device at the QR code to display the product in "Augmented Reality" mode',
    'spatial.arSupportInFollowingDevices' => 'The "Augmented Reality experience" is supported on the following devices:',
    'spatial.arSupportDevices' => 'iOS11+, Android 8.0+ with ARCore 1.9 support',
    'spatial.moveTheDeviceToStart' => 'Move the device to start',
    'spatial.tapToPlaceTheObject' => 'Tap to place the object',
    'spatial.openAugmentedRealityView' => 'Open Augmented Reality view',
    'spatial.augmentedRealityView' => 'Augmented Reality view',
    'spatial.openArView' => 'Open AR view',
    'spatial.openArViewDescription' => 'Open Augmented Reality view',
